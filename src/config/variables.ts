...
export const Terms = [
	...
	{text: "As Empresas autorizam ainda, em caráter irrevogável e irretratável,"+
	...
	{text: "  As Empresas declaram-se cientes de que poderão consultar as"+
		...
		"Público do BACEN."},
	{text: " As eventuais manifestações de discordância quanto às informações"+
		...
		"dezembro de 2017."},
	{text: "  Ainda, as Empresas desde já concordam expressamente em estender a"+
